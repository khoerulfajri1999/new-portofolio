        ...
        <div className="flex flex-col lg:flex-row gap-x-10">
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                <span className="text-gradient">{projects[3].type}</span>
              </div>
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                <span className="text-3xl text-white">{projects[3].title}</span>
              </div>
            </div>
          </motion.div>
          <motion.div
      ...
      {selectedProject && (
        ...
        >
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="bg-white rounded-xl p-6 w-full max-w-[600px] shadow-2xl border border-gray-200 relative"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-gradient bg-clip-text">
            ...
            <div className="flex justify-center">
              <button
                className="btn px-6 py-2 bg-gradient-to-r from-accent to-blue-500 text-white rounded-full hover:from-blue-500 hover:to-accent transition-all duration-300"
                onClick={() => setSelectedProject(null)}
              >
                Close
              </button>
